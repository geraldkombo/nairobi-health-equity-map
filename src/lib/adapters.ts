...
export const REAL_SOURCES: Record<string, SourceEntry[]> = {
  ...
  facilities: [
    ...
    },
    {
      ...
      license: "Research",
      note: "Research programme producing travel time accessibility surfaces using cost and distance analysis. Raw friction GeoTIFFs available upon request accompanying published papers.",
      type: "research",
    },
  ],
  indicators: [
  ...
  methods: [
    ...
    },
    {
      ...
      license: "Research",
      note: "Kenya's leading health research institute. Their geographic access group produces the travel time friction surfaces and cost and distance analysis that underpin this platform's accessibility metric.",
      type: "research",
    },
    {
      ...
      note: "Daily OSM extracts for Kenya in .osm.pbf format. Used as the road network input for AccessMod cost and distance analysis and Protomaps vector tile generation.",
      type: "download",
    },
    {
      ...
      license: "CC-BY-4.0",
      licenseUrl: "https://creativecommons.org/licenses/by/4.0/",
      note: "10 m resolution satellite derived land cover map from the European Space Agency. Used to assign off road walking speeds (bare land, grassland, shrub, forest, water) in the cost and distance analysis.",
      type: "download",
    },
  ],
};
